...
INSERT INTO "user" (id, name, email, emailVerified, image, role, createdAt, updatedAt) VALUES
  ...
  -- newbie: no teams created, no memberships → exercises global empty state on My Teams
...
INSERT INTO team_members (id, user_id, team_id, jersey_number, status, created_at, updated_at) VALUES
  -- player1 memberships: approved + pending across multiple teams
  ...
  -- player2 memberships: pending + rejected
  ...
  -- admin joined River Hawks as a player → exercises both sections on My Teams
  ('tm_6', 'usr_admin',   'team_a', NULL, 'approved', 1700000000000, 1700000000000),
  -- coach-a joined Ghost FC as a player (pending) → exercises both sections on My Teams
  ('tm_7', 'usr_coach_a', 'team_c', NULL, 'pending',  1700000000000, 1700000000000);
